...
%%
M1GT = load_raw('C:\Users\yourb\Desktop\labelM1.raw','*uint8');
M2GT = load_raw('C:\Users\yourb\Desktop\labelM2.raw','*uint8');
M3GT = load_raw('C:\Users\yourb\Desktop\labelM3.raw','*uint8');
siz = [544 544 860];
M1GT = reshape(M1GT,siz); M2GT = reshape(M2GT,siz); M3GT = reshape(M3GT,siz);
%%
M3GT(M3GT == 4 ) = 3;
M3GT(M3GT == 5) = 2;
%M1GT(M1GT == 7) = 3;
...
caxis([0 4])
%%
save_raw(M1GT,'C:\\Users\\yourb\\Desktop\\labelM1.raw','*uint8');
save_raw(M2GT,'C:\\Users\\yourb\\Desktop\\labelM2.raw','*uint8');
save_raw(M3GT,'C:\\Users\\yourb\\Desktop\\labelM3.raw','*uint8');
%%

save_raw(IwM1GT,'C:\\Users\\yourb\\Desktop\\IwlabelM1.raw','*uint8');
save_raw(IwM2GT,'C:\\Users\\yourb\\Desktop\\IwlabelM2.raw','*uint8');
save_raw(IwM3GT,'C:\\Users\\yourb\\Desktop\\IwlabelM3.raw','*uint8');
%%
threold = 10;
