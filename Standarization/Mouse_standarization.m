%%
%Segmentation
M1E1 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\3DVolume\Mouse1\M1E1.raw','single');
M1E2 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\3DVolume\Mouse1\M1E2.raw','single');
M1E3 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\3DVolume\Mouse1\M1E3.raw','single');
M1E4 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\3DVolume\Mouse1\M1E4.raw','single');
M1GT = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\3DVolume\Mouse1\labelM1.raw','*uint8');
siz = [544,544,860];
...
%%
%Input new data
M2E1 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\Wide_spectrum\Mouse2\E1-118.raw','*single');
M2E2 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\Wide_spectrum\Mouse2\E2-118.raw','*single');
%M2E3 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\Wide_spectrum\Mouse2\E3-118.raw','*single');
%M2E4 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\Wide_spectrum\Mouse2\E4-118.raw','*single');
siz = [672 672 792];
...
%%
pmask2 = load_raw('\\tera\user\boku(コスパ改善中)\NZ_data\Mouse\Standarized_mouse_wide\pmaskM2.raw','*uint8');
